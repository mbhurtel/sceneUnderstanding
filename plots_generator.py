...
def generate_inertia_plot(cluster_features_csvs):
    '''
...
def plot_silhouette_scores(data_stats):
    '''
...
def plot_time_taken(data_stats):
    '''
    ...
    plt.grid()
    plt.savefig("Output/experimental_plots/time_taken.jpg", dpi=300, bbox_inches="tight")
    plt.figure().clear(True)
